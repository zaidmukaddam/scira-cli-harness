...
CASE_GROUPS = {
    "SimpleQA": [
        "simpleqa-design",
        "simpleqa-quality-check",
        "simpleqa-grading-labels",
        "simpleqa-edge-grade",
        "simpleqa-vs-browsecomp",
    ],
    "BrowseComp": [
        "browsecomp-size",
        "browsecomp-human-difficulty",
        "browsecomp-unsolved-math",
        "browsecomp-challenge-checks",
        "browsecomp-best-caveat",
        "browsecomp-browsing-delta",
        "browsecomp-model-baselines",
    ],
    "GAIA": ["gaia-counts", "gaia-capability-gap", "gaia-philosophy-contrast"],
    "Flue": [
        "flue-start-commands",
        "flue-cloudflare-negative",
        "flue-model-selection",
        "flue-layout-rules",
    ],
}
...
RAW = {
    ...
    ("simpleqa-design", "parallel", "xai/grok-4.3"): 92,
    (
        "simpleqa-design",
        "parallel",
    ...
    ("simpleqa-design", "exa", "xai/grok-4-1-fast-non-reasoning"): 92,
    ...
    ("simpleqa-design", "exa", "xai/grok-4.3"): 92,
    (
        "simpleqa-design",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("simpleqa-quality-check", "parallel", "xai/grok-4-1-fast-non-reasoning"): 100,
    ...
    ("simpleqa-quality-check", "parallel", "xai/grok-4.3"): 100,
    (
        "simpleqa-quality-check",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("simpleqa-quality-check", "exa", "xai/grok-4-1-fast-non-reasoning"): 100,
    ("simpleqa-quality-check", "exa", "xai/grok-4-1-fast"): 100,
    ...
    ("simpleqa-quality-check", "exa", "xai/grok-4.3"): 100,
    (
        "simpleqa-quality-check",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("simpleqa-grading-labels", "parallel", "xai/grok-4.3"): 92,
    (
        "simpleqa-grading-labels",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("simpleqa-grading-labels", "exa", "xai/grok-4.20-0309-non-reasoning"): 100,
    ("simpleqa-grading-labels", "exa", "xai/grok-4.20-0309-reasoning"): 85,
    ("simpleqa-grading-labels", "exa", "xai/grok-4.3"): 77,
    (
        "simpleqa-grading-labels",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("simpleqa-edge-grade", "parallel", "xai/grok-4.3"): 92,
    (
        "simpleqa-edge-grade",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("simpleqa-edge-grade", "exa", "xai/grok-4-1-fast-non-reasoning"): 100,
    ...
    ("simpleqa-edge-grade", "exa", "xai/grok-4.3"): 92,
    (
        "simpleqa-edge-grade",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("simpleqa-vs-browsecomp", "parallel", "xai/grok-4-1-fast"): 100,
    ...
    ("simpleqa-vs-browsecomp", "parallel", "xai/grok-4.3"): 100,
    (
        "simpleqa-vs-browsecomp",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("simpleqa-vs-browsecomp", "exa", "xai/grok-4.3"): 92,
    (
        "simpleqa-vs-browsecomp",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-size", "parallel", "xai/grok-4-1-fast-non-reasoning"): 100,
    ...
    ("browsecomp-size", "parallel", "xai/grok-4.3"): 92,
    (
        "browsecomp-size",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-size", "exa", "xai/grok-4.3"): 100,
    (
        "browsecomp-size",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-human-difficulty", "parallel", "xai/grok-4-1-fast"): 79,
    ("browsecomp-human-difficulty", "parallel", "xai/grok-4.20-0309-non-reasoning"): 92,
    ("browsecomp-human-difficulty", "parallel", "xai/grok-4.20-0309-reasoning"): 100,
    ("browsecomp-human-difficulty", "parallel", "xai/grok-4.3"): 100,
    (
        "browsecomp-human-difficulty",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-human-difficulty", "exa", "xai/grok-4-1-fast-non-reasoning"): 79,
    ("browsecomp-human-difficulty", "exa", "xai/grok-4-1-fast"): 100,
    ("browsecomp-human-difficulty", "exa", "xai/grok-4.20-0309-non-reasoning"): 79,
    ("browsecomp-human-difficulty", "exa", "xai/grok-4.20-0309-reasoning"): 79,
    ("browsecomp-human-difficulty", "exa", "xai/grok-4.3"): 71,
    (
        "browsecomp-human-difficulty",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-unsolved-math", "parallel", "xai/grok-4-1-fast-non-reasoning"): 92,
    ...
    ("browsecomp-unsolved-math", "parallel", "xai/grok-4.20-0309-reasoning"): 92,
    ("browsecomp-unsolved-math", "parallel", "xai/grok-4.3"): 92,
    (
        "browsecomp-unsolved-math",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-unsolved-math", "exa", "xai/grok-4-1-fast"): 100,
    ...
    ("browsecomp-unsolved-math", "exa", "xai/grok-4.3"): 92,
    (
        "browsecomp-unsolved-math",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-challenge-checks", "parallel", "xai/grok-4.3"): 79,
    (
        "browsecomp-challenge-checks",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-challenge-checks", "exa", "xai/grok-4-1-fast-non-reasoning"): 51,
    ("browsecomp-challenge-checks", "exa", "xai/grok-4-1-fast"): 38,
    ("browsecomp-challenge-checks", "exa", "xai/grok-4.20-0309-non-reasoning"): 38,
    ("browsecomp-challenge-checks", "exa", "xai/grok-4.20-0309-reasoning"): 59,
    ("browsecomp-challenge-checks", "exa", "xai/grok-4.3"): 92,
    (
        "browsecomp-challenge-checks",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-best-caveat", "parallel", "xai/grok-4.3"): 100,
    (
        "browsecomp-best-caveat",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-best-caveat", "exa", "xai/grok-4-1-fast-non-reasoning"): 92,
    ("browsecomp-best-caveat", "exa", "xai/grok-4-1-fast"): 79,
    ...
    ("browsecomp-best-caveat", "exa", "xai/grok-4.3"): 92,
    (
        "browsecomp-best-caveat",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-browsing-delta", "parallel", "xai/grok-4.3"): 100,
    (
        "browsecomp-browsing-delta",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-browsing-delta", "exa", "xai/grok-4-1-fast-non-reasoning"): 100,
    ("browsecomp-browsing-delta", "exa", "xai/grok-4-1-fast"): 79,
    ("browsecomp-browsing-delta", "exa", "xai/grok-4.20-0309-non-reasoning"): 100,
    ("browsecomp-browsing-delta", "exa", "xai/grok-4.20-0309-reasoning"): 92,
    ("browsecomp-browsing-delta", "exa", "xai/grok-4.3"): 92,
    (
        "browsecomp-browsing-delta",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-model-baselines", "parallel", "xai/grok-4.3"): 100,
    (
        "browsecomp-model-baselines",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("browsecomp-model-baselines", "exa", "xai/grok-4-1-fast-non-reasoning"): 100,
    ("browsecomp-model-baselines", "exa", "xai/grok-4-1-fast"): 85,
    ("browsecomp-model-baselines", "exa", "xai/grok-4.20-0309-non-reasoning"): 100,
    ("browsecomp-model-baselines", "exa", "xai/grok-4.20-0309-reasoning"): 92,
    ("browsecomp-model-baselines", "exa", "xai/grok-4.3"): 92,
    (
        "browsecomp-model-baselines",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("gaia-counts", "parallel", "xai/grok-4.3"): 100,
    (
        "gaia-counts",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("gaia-counts", "exa", "xai/grok-4.3"): 92,
    (
        "gaia-counts",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("gaia-capability-gap", "parallel", "xai/grok-4-1-fast"): 75,
    ("gaia-capability-gap", "parallel", "xai/grok-4.20-0309-non-reasoning"): 75,
    ("gaia-capability-gap", "parallel", "xai/grok-4.20-0309-reasoning"): 100,
    ("gaia-capability-gap", "parallel", "xai/grok-4.3"): 100,
    (
        "gaia-capability-gap",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("gaia-capability-gap", "exa", "xai/grok-4.3"): 100,
    (
        "gaia-capability-gap",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("gaia-philosophy-contrast", "parallel", "xai/grok-4-1-fast"): 100,
    ("gaia-philosophy-contrast", "parallel", "xai/grok-4.20-0309-non-reasoning"): 85,
    ("gaia-philosophy-contrast", "parallel", "xai/grok-4.20-0309-reasoning"): 85,
    ("gaia-philosophy-contrast", "parallel", "xai/grok-4.3"): 77,
    (
        "gaia-philosophy-contrast",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ): 100,
    (
    ...
    ("gaia-philosophy-contrast", "exa", "xai/grok-4.20-0309-reasoning"): 100,
    ("gaia-philosophy-contrast", "exa", "xai/grok-4.3"): 100,
    (
        "gaia-philosophy-contrast",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("flue-start-commands", "parallel", "xai/grok-4-1-fast"): 38,
    ("flue-start-commands", "parallel", "xai/grok-4.20-0309-non-reasoning"): 79,
    ("flue-start-commands", "parallel", "xai/grok-4.20-0309-reasoning"): 71,
    ("flue-start-commands", "parallel", "xai/grok-4.3"): 59,
    (
        "flue-start-commands",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("flue-cloudflare-negative", "parallel", "xai/grok-4.3"): 100,
    (
        "flue-cloudflare-negative",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("flue-cloudflare-negative", "exa", "xai/grok-4-1-fast-non-reasoning"): 100,
    ("flue-cloudflare-negative", "exa", "xai/grok-4-1-fast"): 100,
    ("flue-cloudflare-negative", "exa", "xai/grok-4.20-0309-non-reasoning"): 100,
    ("flue-cloudflare-negative", "exa", "xai/grok-4.20-0309-reasoning"): 100,
    ("flue-cloudflare-negative", "exa", "xai/grok-4.3"): 49,
    (
        "flue-cloudflare-negative",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("flue-model-selection", "parallel", "xai/grok-4-1-fast-non-reasoning"): 92,
    ...
    ("flue-model-selection", "parallel", "xai/grok-4.3"): 92,
    (
        "flue-model-selection",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("flue-model-selection", "exa", "xai/grok-4-1-fast-non-reasoning"): 100,
    ("flue-model-selection", "exa", "xai/grok-4-1-fast"): 100,
    ("flue-model-selection", "exa", "xai/grok-4.20-0309-non-reasoning"): 100,
    ("flue-model-selection", "exa", "xai/grok-4.20-0309-reasoning"): 100,
    ("flue-model-selection", "exa", "xai/grok-4.3"): 92,
    (
        "flue-model-selection",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("flue-layout-rules", "parallel", "xai/grok-4-1-fast-non-reasoning"): 92,
    ("flue-layout-rules", "parallel", "xai/grok-4-1-fast"): 92,
    ("flue-layout-rules", "parallel", "xai/grok-4.20-0309-non-reasoning"): 100,
    ("flue-layout-rules", "parallel", "xai/grok-4.20-0309-reasoning"): 100,
    ("flue-layout-rules", "parallel", "xai/grok-4.3"): 92,
    (
        "flue-layout-rules",
        "parallel",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
    ...
    ("flue-layout-rules", "exa", "xai/grok-4-1-fast-non-reasoning"): 100,
    ("flue-layout-rules", "exa", "xai/grok-4-1-fast"): 100,
    ("flue-layout-rules", "exa", "xai/grok-4.20-0309-non-reasoning"): 100,
    ("flue-layout-rules", "exa", "xai/grok-4.20-0309-reasoning"): 100,
    ("flue-layout-rules", "exa", "xai/grok-4.3"): 92,
    (
        "flue-layout-rules",
        "exa",
        "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6",
...
SUMMARY = {
    ("parallel", "xai/grok-4-1-fast-non-reasoning"): {"avg": 98.7, "passes": 16, "dur": 30.6},
    ("parallel", "xai/grok-4-1-fast"): {"avg": 93.9, "passes": 15, "dur": 34.0},
    ("parallel", "xai/grok-4.20-0309-non-reasoning"): {"avg": 96.4, "passes": 15, "dur": 19.0},
    ("parallel", "xai/grok-4.20-0309-reasoning"): {"avg": 97.3, "passes": 16, "dur": 27.6},
    ("parallel", "xai/grok-4.3"): {"avg": 92.6, "passes": 9, "dur": 22.5},
    ("parallel", "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6"): {"avg": 98.5, "passes": 18, "dur": 38.8},
    ("parallel", "cloudflare-workers-ai/@cf/nvidia/nemotron-3-120b-a12b"): {"avg": 87.7, "passes": 2, "dur": 30.6},
    ("parallel", "cloudflare-workers-ai/@cf/google/gemma-4-26b-a4b-it"): {"avg": 89.7, "passes": 13, "dur": 51.0},
    ("exa", "xai/grok-4-1-fast-non-reasoning"): {"avg": 90.9, "passes": 13, "dur": 53.4},
    ("exa", "xai/grok-4-1-fast"): {"avg": 89.4, "passes": 13, "dur": 47.7},
    ("exa", "xai/grok-4.20-0309-non-reasoning"): {"avg": 93.7, "passes": 15, "dur": 23.1},
    ("exa", "xai/grok-4.20-0309-reasoning"): {"avg": 94.0, "passes": 13, "dur": 28.3},
    ("exa", "xai/grok-4.3"): {"avg": 86.3, "passes": 4, "dur": 22.0},
    ("exa", "cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6"): {"avg": 95.4, "passes": 16, "dur": 113.0},
    ("exa", "cloudflare-workers-ai/@cf/nvidia/nemotron-3-120b-a12b"): {"avg": 73.6, "passes": 0, "dur": 92.3},
    ("exa", "cloudflare-workers-ai/@cf/google/gemma-4-26b-a4b-it"): {"avg": 82.2, "passes": 8, "dur": 62.7},
}
...
# Figure header rule (figure fraction). Lower leaves more space between rule and legend/chart.
HEADER_RULE_Y = 0.828


def draw_legend_strip(fig, x_start, y, providers, logos=None, label="PROVIDERS"):
...
def style_ax(ax, xlabel=None, ylabel=None, grid_axis="y"):
    ...
    if grid_axis:
        ax.grid(
            axis=grid_axis, color=RULE_SOFT, linewidth=0.7, alpha=1.0, linestyle="-"
        )
...
def draw_header(fig, logos, title, subtitle, eyebrow="SCIRA RESEARCH BENCHMARK"):
    ...
    fig.text(
        0.06, 0.874, subtitle, ha="left", va="center", color=INK_SOFT, fontsize=11.5
    )

    # Right: logo + Be Vietnam Pro Light wordmark, vertically centered as a lockup.
    ...
    if "scira" in logos:
        ...
        add_logo(
            fig,
            logos["scira"],
            (logo_anchor_x, lockup_y),
            zoom=0.048,
            alignment=(1.0, 0.5),
        )

    # Clear separation below the wordmark / icon (va=center on both was visually colliding).
    fig.text(
        wordmark_x,
        0.854,
        spaced("RESEARCH BENCHMARK"),
        ha="right",
        va="center",
        color=INK_MUTE,
        fontsize=8.5,
...
def draw_footer(_fig):
    """No figure footer: run metadata lives in the article caption, not under every PNG."""
    return
...
def chart_overall_bar(logos, out_dir):
    ...
    ax = fig.add_axes([0.075, 0.10, 0.86, 0.628])
    ...
    draw_legend_strip(fig, x_start=0.075, y=0.744, providers=PROVIDERS, logos=logos)
...
def chart_heatmap(logos, out_dir):
    ...
    for ax_idx, provider in enumerate(PROVIDERS):
        ...
        data = np.array(
            [[RAW.get((c, provider, m), np.nan) for m in MODELS] for c in ALL_CASES],
            dtype=float,
        )
        ...
        ax.set_xticklabels(col_labels, color=INK, fontsize=9.5, rotation=30, ha="right")
    ...
    # Provider key in figure margin only (no labels over the matrix).
    draw_legend_strip(fig, x_start=0.075, y=0.778, providers=PROVIDERS, logos=logos)
...
def chart_radar(logos, out_dir):
    ...
    for idx, provider in enumerate(PROVIDERS):
        ax = fig.add_axes([0.07 + idx * 0.46, 0.08, 0.38, 0.57], projection="polar")
        ax.set_facecolor(SURFACE)
        ...
        for grp, cases in CASE_GROUPS.items():
            ...
            vals.append(float(np.nanmean(scores)) if scores else 0.0)
        vals += vals[:1]
        ...
        ax.set_xticklabels(group_names, color=INK, fontsize=11.5, fontweight="600")
        ax.tick_params(axis="x", pad=24)
        ax.set_ylim(40, 100)
        ax.set_yticks([60, 70, 80, 90, 100])
        ax.set_yticklabels(["60", "70", "80", "90", "100"], color=INK_MUTE, fontsize=8)
...
def chart_subcase_bars(logos, out_dir):
    ...
    draw_header(
        ...
        subtitle="Average score per sub-case, per provider, averaged across all 8 models.",
    )
    ...
    for i, (grp_name, cases) in enumerate(CASE_GROUPS.items()):
        ...
        for j, provider in enumerate(PROVIDERS):
            scores = []
            for c in cases:
                vs = [RAW[(c, provider, m)] for m in MODELS if (c, provider, m) in RAW]
                scores.append(float(np.nanmean(vs)) if vs else 0.0)
            offset = (j - 0.5) * w
            color = PROVIDER_COLORS[provider]
            bars = ax.bar(
                x + offset,
        ...
        ax.set_xticks(x)
        ax.set_xticklabels(case_labels, rotation=20, ha="right", color=INK, fontsize=10)
        ax.set_ylim(20, 110)
        ax.set_yticks([20, 40, 60, 80, 100])
        style_ax(ax, ylabel="Avg score", grid_axis="y")

        # Category title above (keep below the figure-level provider strip).
        ax.text(
            0,
            1.07,
            spaced(grp_name.upper()),
            transform=ax.transAxes,
            color=INK,
            fontsize=13,
            fontweight="bold",
    ...
    # Legend in the margin under the header rule: higher y + right start avoids
    # colliding with left-column category titles (SIMPLEQA, etc.).
    draw_legend_strip(fig, x_start=0.56, y=0.775, providers=PROVIDERS, logos=logos)
...
def chart_speed_accuracy(logos, out_dir):
    fig = plt.figure(figsize=(16.5, 9.5), facecolor=BG)
    draw_header(
        fig,
        logos,
    ...
    ax = fig.add_axes([0.065, 0.075, 0.89, 0.605])

    style_ax(
        ax,
        xlabel="Average duration per case (seconds)",
    ...
    # Precompute limits so label seeds use a ring in data units (tighter clusters need
    # non-overlapping starts; adjust_text then pulls toward targets without stacking).
    pre_xs = [
        float(SUMMARY[(p, m)]["dur"]) for p in PROVIDERS for m in MODELS
    ]
    pre_ys = [
        float(SUMMARY[(p, m)]["avg"]) for p in PROVIDERS for m in MODELS
    ]
    x_max = max(pre_xs) if pre_xs else 75.0
    x_pad = max(5.0, 0.07 * (x_max or 1.0))
    x_lim_hi = x_max + x_pad
    y_min, y_max = (min(pre_ys) if pre_ys else 70.0), (max(pre_ys) if pre_ys else 100.0)
    y_pad = max(2.5, 0.05 * (y_max - y_min or 1.0))
    y_lim_lo = max(67.0, y_min - y_pad)
    y_lim_hi = min(102.5, y_max + y_pad)
    x_span = x_lim_hi
    y_span = max(y_lim_hi - y_lim_lo, 1e-6)
    ring_rx = min(x_span * 0.024, 7.0)
    ring_ry = min(y_span * 0.038, 3.8)

    texts = []
    xs: list[float] = []
    ys: list[float] = []
    idx = 0
    n_pts = len(PROVIDERS) * len(MODELS)
    for provider in PROVIDERS:
        color = PROVIDER_COLORS[provider]
        for model in MODELS:
            d = SUMMARY[(provider, model)]
            x, y = float(d["dur"]), float(d["avg"])
            xs.append(x)
            ys.append(y)
            ax.scatter(
                x,
            ...
            ang = 2 * np.pi * (idx + 0.35 * (0 if provider == "parallel" else 1)) / max(
                n_pts, 1
            )
            tx = x + ring_rx * float(np.cos(ang))
            ty = y + ring_ry * float(np.sin(ang))
            t = ax.text(
                tx,
                ty,
                label,
    ...
    # Realize text bboxes before adjust_text (avoids non-finite KDTree input on some backends).
    fig.canvas.draw()
    ...
    adjust_text(
        ...
        ax=ax,
        expand=(1.38, 1.48),
        force_text=(0.42, 0.52),
        force_static=(0.38, 0.44),
        force_pull=(0.07, 0.11),
        force_explode=(0.32, 0.5),
        max_move=(48, 48),
        iter_lim=450,
        arrowprops=dict(
            arrowstyle="-", color=INK_MUTE, lw=0.65, alpha=0.55, shrinkA=2, shrinkB=5
        ),
    ...
    # Corner hints (axes fraction so they stay inside the plot, clear of figure-level legend).
    ax.text(
        0.02,
        0.98,
    ...
    # Legend strip sits in figure margin above the axes (y ≈ 0.72), not inside the data box.
    draw_legend_strip(fig, x_start=0.075, y=0.718, providers=PROVIDERS, logos=logos)
...
def chart_model_ranking(logos, out_dir):
    ...
    gs = gridspec.GridSpec(
        1, 2, figure=fig, left=0.10, right=0.96, top=0.698, bottom=0.07, wspace=0.40
    )
    ...
    for ax_idx, provider in enumerate(PROVIDERS):
        ...
        ax.barh(y, [100] * len(items), height=0.55, color=RULE_SOFT, zorder=2)
        bars = ax.barh(
            y, scores, height=0.55, color=color, alpha=PROVIDER_FILL_ALPHA, zorder=3
        )
        ...
        provider_pill(ax, provider, x=0.0, y=1.058, logos=logos, name_size=15)
